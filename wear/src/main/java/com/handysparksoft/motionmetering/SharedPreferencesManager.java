...
public class SharedPreferencesManager {
    public static String PREFERENCE_ALTITUDE_DIFF_KEY = "preference_altitude_diff_key";

    private static SharedPreferencesManager mSharedPreferencesManger;
    ...
    private SharedPreferencesManager(Context context) {
        mContext = context;
        mSharedPreferences = context.getSharedPreferences("MyWearPreferences", Context.MODE_PRIVATE);
    ...
    public static synchronized SharedPreferencesManager getInstance(Context context) {
        ...
        if (mSharedPreferencesManger == null) {
            mSharedPreferencesManger = new SharedPreferencesManager(context.getApplicationContext());
        }
        return mSharedPreferencesManger;
    }
